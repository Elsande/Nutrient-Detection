$(function () {
  ...
  var confusionMatrixOptions = {
    ...
    // Tambahan konfigurasi sesuai kebutuhan
  };
  ...
  var confusionMatrixData = {
    ...
    datasets: [{
      ...
      data: [[0.86,0.93], [0.73,0.94]], // Isi data sesuai dengan confusion matrix yang ingin ditampilkan
      backgroundColor: [
        'rgba(255, 99, 132, 0.5)',
        'rgba(54, 162, 235, 0.5)',
      ],
...
if ($("#confusionMatrixChart").length) {
  var confusionMatrixCanvas = $("#confusionMatrixChart").get(0).getContext("2d");
  var confusionMatrixChart = new Chart(confusionMatrixCanvas, {
    type: 'bar', // Atur tipe grafik sesuai kebutuhan (contoh: 'bar', 'line', 'scatter', dll.)
